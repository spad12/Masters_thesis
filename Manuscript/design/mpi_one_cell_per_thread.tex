...
\node [shift={(-1.0cm,-2cm)}]
	{
		...
		\node [shift={(3cm,0cm)}] at (a1) (a2)
			...
			\begin{scope}[start chain=1 going right,start chain=3 going down,start chain=2 going right,node distance=-1.0mm]
				 ...
				 \node [on chain=1,tmtape,cfill1] (j5) {j+4};
				 \node [on chain=1,tmtape,cfill2] (j6) {j+5};
				 \node [on chain=2,tmtape,cfill3,yshift=-.985cm] at (j5) (j7) {j+6};
				 \node [on chain=2,tmtape,cfill4] (j8) {j+7};
		...
		\node [shift={(3cm,0cm)}] at (a2)
			...
			\begin{scope}[start chain=1 going right,start chain=2 going right,start chain=3 going down,node distance=-1.0mm]
				 ...
				 \node [on chain=1,tmtape,cfill1] (j9) {j+8};
				 \node [on chain=1,tmtape,cfill2] (j10) {j+9};
				 \node [on chain=2,tmtape,cfill3,yshift=-.985cm] at (j9) (j11) {j+10};
				 \node [on chain=2,tmtape,cfill4] (j12) {j+11};
